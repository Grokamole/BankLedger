...
{
    /// <summary>
    /// This interface is used for the ledger database access layer.
    /// </summary>
    public interface ILedgerDatabaseAccess
    {
        /// <summary>
        ...
        bool Deposit(long sessionID, decimal amount);
        ...
        bool Withdrawal(long sessionID, decimal amount);
